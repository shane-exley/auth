...
func (_m *RedisClient) Del(_a0 context.Context, _a1 ...string) *redis.IntCmd {
...
func (_m *RedisClient) Get(_a0 context.Context, _a1 string) *redis.StringCmd {
...
func (_m *RedisClient) Set(_a0 context.Context, _a1 string, _a2 interface{}, _a3 time.Duration) *redis.StatusCmd {
